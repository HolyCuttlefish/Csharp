...
namespace ConsoleApp1
{
    class Program
    {
        ...
        static int count, nakopitel = 0, konynk = 0, dezunk = 0, eqivalent = 0, implik = 0;
        ...
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("& = коньюнкция");
            //Console.WriteLine("+ = дезьюнкция");
            //Console.WriteLine("~ = эквивалентность");
            //Console.WriteLine("> = импликация");
            //Console.WriteLine("Малеькая буква = отрицание");
            //Console.WriteLine();
